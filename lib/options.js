var sanitizers = [
	...
	function(opts) {
		...
		if (opts.configFile) {
			try {
				...
				throw('Could not read or parse configuration file %s', opts.configFile, e);
			}
	...
	function(opts) {
		...
		passedBrowsers.forEach(function(passedBrowser) {
			...
			if (passedBrowser.browserName.match(/android/gi)) {
			...
			if (typeof passedBrowser.platform === 'undefined') {
