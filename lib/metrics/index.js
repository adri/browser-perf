var Q = require('q'),
	...
	debug = require('debug')('browserperf:Metrics')
...
Metrics.prototype.allMetrics = function(method, args) {
	return this.metrics.map(function(metric) {
		return function() {
			debug(metric.id, method, typeof metric[method] === 'function' ? 'called' : 'not called');
...
module.exports.builtIns = [
	// 'GpuBenchmarkingRenderingStats', Now obselete as this function no longer exists
	'RafRenderingStats',
	'NavTimingMetrics',
