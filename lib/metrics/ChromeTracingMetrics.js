var BaseMetrics = require('./BaseMetrics'),
	...
	debug = require('debug')('browserperf:ChromeTracingMetrics');
...
ChromeTracingMetrics.prototype.getResults = function() {
	...
	if (this.tracingStats.length > 0) {
		...
		if (mean_frame_time) {
			...
			debug('Mean frame time is null, number of frames are ', stats.frame_times.length);
		}
